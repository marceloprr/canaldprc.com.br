    ...
    <Layout home>
      ...
      <section className={utilStyles.headingMdCenter}>
        ...
        <h1 className={utilStyles.heading2Xl}>
          ...
          <br />
          Sejam todos bem vindos ao Canal DPRC!
        </h1>
        <br />
        <p>
          Esse é o site sobre canal DPRC no{" "}
          <a href="/redir/mainchannel" target="_blank">
            Youtube{" "}
            <Image src="/images/yt_icon_rgb.png" height={20} width={26} />
          </a>{" "}
          protagonizado por Christian e MarceloP!!
        </p>
        <p>
          Atualmente nosso canal está com {channelStatistics.subscriberCount}{" "}
          inscritos, e se você não é inscrito ainda, clique{" "}
          <a href="/redir/mainchannel?subscribe" target="_blank">
            aqui
          </a>{" "}
          e inscreva-se agora!!!
        </p>
      ...
      <section className={`${utilStyles.headingMd} ${utilStyles.padding1px}`}>
        <div className={utilStyles.headingLastPublish}>
          <h2 className={utilStyles.headingX2Center}>
            Vejam nossas últimas publicações
          </h2>
        </div>
        <br />
        <div className={utilStyles.videoList}>
          {lastestVideos.titles.map(
            ({ id, title, description, pubDate, thumbnail }) => (
              <>
